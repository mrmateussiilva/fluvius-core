...
- A sincronização de contatos também atualiza grupos que já possuem conversa operacional. A importação do diretório de grupos do provider é cache auxiliar e não cria atendimento sem mensagem recebida.
