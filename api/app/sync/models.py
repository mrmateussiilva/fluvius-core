...
class SyncRun(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    contact_items: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    group_items: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    message_event_items: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    imported_group_items: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
